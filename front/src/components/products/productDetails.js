...
import { useParams } from 'react-router-dom' //Para manejar los parametros que estan en el back
...
export const ProductDetails = () => {
  ...
  const { id } = useParams(); // useParams se ocupa de buscar el Id en el cuerpo body del json
  ...
  }, [dispatch, alert, error, id])// [dispatch] indica que nos muestre lo que despacharon

  //Creamos funciones para controlar aumento o disminución de productos
  const increaseQty = () => {
        ...
        <Fragment>
          ...
          <div className='row d-flex justify-content-around'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
              ...
              {/*Mensaje Emergente para dejar la opinión y calificación*/}

              <div className='row mt-2 mb-5'>
                <div className='raiting w-50'>
